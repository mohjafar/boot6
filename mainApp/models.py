from django.db import models #user jafarraza (password=123456789admin
...
class Product(models.Model):
    ...
    stoke=models.CharField(max_length=20,default="In stoke",null=True,blank=True)
...
class Buyer(models.Model):
    ...
    otp= models.IntegerField(default=-1345658)
    def __str__(self):
...
status = ((0,"Oder Placed"),(1,"Not Packed"),(2,"Packed"),(3,"Ready to ship"),(4,"Shipped"),(5,"Out For Delivery"),(6,"Delivered"),(7,"Cancelled"))
