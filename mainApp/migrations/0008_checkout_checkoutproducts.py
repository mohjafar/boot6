    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderstatus', models.IntegerField(choices=[(0, 'Oder Placed'), (1, 'Not Packed'), (2, 'Packed'), (3, 'Ready to ship'), (4, 'Shipped'), (5, 'Out For Delivery'), (6, 'Delivered'), (7, 'Cancelled')], default=0)),
